...
async function generateTivetGuard() {
	const outputDevFull = resolve(
		import.meta.dirname!,
		"../../docker/dev-full/tivet-guard/traefik.yaml",
	);
	const outputMonolith = resolve(
		import.meta.dirname!,
		"../../docker/monolith/tivet-guard/traefik.yaml",
	);
	...
	const config = {
		...
		providers: {
			...
			http: {
				endpoint:
					"http://tivet-server:8081/traefik-provider/config/game-guard?datacenter=f288913c-735d-4188-bf9b-2fcf6eac7b9c",
				pollInterval: "0.5s",
			},
		},
	};
